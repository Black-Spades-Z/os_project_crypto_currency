...
public class WalletWindow : CCTPSApp
{
    ...
    public static Button miner_button_wallet_admin_window;
	...
	static WalletWindow()
    	{
        	...
        	for(int i=0; i < walletId.Count;i++)
        	{
...
// Define the event handler methods for each button in the miners admin window
    ...
    public static void OnMinerButtonClickedInWalletAdminWindow(object sender, EventArgs e)
    {
      //  wallet_admin_window.Hide();
	//	block_admin_window.ShowAll();
    }
    ...
    public static void OnLogoutButtonClickedInWalletAdminWindow(object sender, EventArgs e)
    {
    	...
    	public static void AddFrameToMarketValuesWalletWindow(int index)
{
    // Create a new frame
    ...
    Button walletAddressButton = new Button("show");
